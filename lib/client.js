...
// src/state.js
var pluginConfig = { enabled: true, editor: "", showRestart: true, menuQuickActions: false, sessionDoneMark: false, flatListStyle: true, headerViewSwitches: false, messageDelete: true, conversationNav: true };
var runtimeCtx = null;
...
function showDeleteConfirm(role, seq) {
  ...
  desc.textContent = isUser ? "\u5C06\u5220\u9664\u8BE5\u6D88\u606F\u53CA\u5176\u540E\u7EED\u56DE\u590D\uFF0C\u6A21\u578B\u5C06\u4E0D\u518D\u8BB0\u5F97\u8FD9\u6761\u5BF9\u8BDD\u5185\u5BB9\u3002\u6B64\u64CD\u4F5C\u4E0D\u53EF\u6062\u590D\uFF08\u6A21\u578B\u89C6\u89D2\uFF09\u3002" : "\u5C06\u5220\u9664\u8BE5\u56DE\u7B54\uFF0C\u6A21\u578B\u5C06\u4E0D\u518D\u8BB0\u5F97\u8FD9\u6761\u5185\u5BB9\u3002\u6B64\u64CD\u4F5C\u4E0D\u53EF\u6062\u590D\uFF08\u6A21\u578B\u89C6\u89D2\uFF09\u3002";
  ...
  const onKey = (e) => {
    if (e.key === "Escape") closeDeleteOverlay();
  };
  const onDown = (e) => {
    if (e.target === overlay) closeDeleteOverlay();
  };
...
var PANEL_WIDTH = 26;
var PANEL_HEIGHT_RATIO = 0.5;
var MIN_PANEL_HEIGHT = 140;
var MAX_PANEL_HEIGHT = 520;
var MARKER_SIZE = 6;
var RIGHT_MARGIN = 10;
var HOVER_ZONE_X = 28;
var HOVER_ZONE_Y = 24;
var IDLE_HIDE_MS = 450;
var FADE_IN_MS = 200;
var FADE_OUT_MS = 400;
...
var Rail = class {
  ...
  pointerInZone() {
    ...
    return this.pointerX >= rect.left - HOVER_ZONE_X && this.pointerX <= rect.right + HOVER_ZONE_X && this.pointerY >= rect.top - HOVER_ZONE_Y && this.pointerY <= rect.bottom + HOVER_ZONE_Y;
  }
  /** 立即显示面板（取消待执行的淡出）。 */
  showPanel() {
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("div", { className: "nio-settings-desc" }, "\u5F00\u542F\u540E\uFF0C\u5DE5\u4F5C\u533A/\u4F1A\u8BDD\u5217\u8868\u5934\u90E8\uFF08\u641C\u7D22\u3001\u5206\u7EC4\u65B9\u5F0F\u3001\u6392\u5E8F\u65B9\u5F0F\u3001\u65B0\u589E\u9879\u76EE\u6240\u5728\u884C\uFF09\u4FDD\u6301\u539F\u6709\u56FE\u6807\u4E0D\u53D8\uFF0C\u989D\u5916\u6DFB\u52A0\u4E00\u4E2A\u300C\u5207\u6362\u5206\u7EC4\u65B9\u5F0F\u300D\u5FEB\u6377\u56FE\u6807\uFF08\u6309\u5DE5\u4F5C\u533A \u21C4 \u5355\u5217\u8868\uFF09\uFF0C\u70B9\u51FB\u76F4\u63A5\u5207\u6362\u5E76\u5E26\u60AC\u6D6E\u63D0\u793A\uFF1B\u5173\u95ED\u5219\u6062\u590D\u539F\u6837")
        ),
        import_react.default.createElement(
          "label",
          { className: "nio-settings-toggle" },
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          "div",
          { className: "nio-settings-text" },
          import_react.default.createElement("div", { className: "nio-settings-title" }, "\u6D88\u606F\u5220\u9664"),
          import_react.default.createElement("div", { className: "nio-settings-desc" }, "\u5F00\u542F\u540E\uFF0C\u6BCF\u6761\u7528\u6237\u6D88\u606F / \u5927\u6A21\u578B\u56DE\u590D\u4E0B\u65B9\u64CD\u4F5C\u6309\u94AE\u884C\u51FA\u73B0\u300C\u5220\u9664\u300D\u6309\u94AE\uFF1A\u70B9\u51FB\u53EF\u5C06\u8BE5\u6D88\u606F\uFF08\u53CA\u7528\u6237\u6D88\u606F\u7684\u540E\u7EED\u56DE\u590D\uFF09\u4ECE\u4F1A\u8BDD\u4E2D\u5220\u9664\uFF0C\u6A21\u578B\u5C06\u4E0D\u518D\u8BB0\u5F97\u8FD9\u6761\u5185\u5BB9")
        ),
        import_react.default.createElement(
          "label",
          { className: "nio-settings-toggle" },
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("div", { className: "nio-settings-desc" }, "\u5F00\u542F\u540E\uFF0C\u4F1A\u8BDD\u804A\u5929\u533A\u57DF\u53F3\u4FA7\u663E\u793A\u672C\u4F1A\u8BDD\u7684\u7528\u6237\u6D88\u606F\u5BFC\u822A\u6761\uFF1A\u6BCF\u6761\u7528\u6237\u6D88\u606F\u4E00\u4E2A\u6807\u8BB0\uFF0C\u60AC\u505C\u67E5\u770B\u63D0\u95EE\u6458\u8981\u3001\u70B9\u51FB\u8DF3\u8F6C\uFF08\u590D\u523B DeepSeek \u7F51\u9875\u7248\u6837\u5F0F\uFF09\uFF1B\u7528\u6237\u6D88\u606F\u5C11\u4E8E\u4E24\u6761\u6216\u5185\u5BB9\u672A\u8D85\u4E00\u5C4F\u65F6\u4E0D\u663E\u793A")
        ),
        import_react.default.createElement(
          "label",
          { className: "nio-settings-toggle" },
