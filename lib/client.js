...
// src/state.js
var pluginConfig = { enabled: true, editor: "", showRestart: true, menuQuickActions: false, sessionDoneMark: false, flatListStyle: true, headerViewSwitches: false, conversationNav: true };
var runtimeCtx = null;
...
function applyConfigPatch(next) {
  const changed = next && (typeof next.enabled === "boolean" || typeof next.editor === "string" || typeof next.showRestart === "boolean" || typeof next.menuQuickActions === "boolean" || typeof next.sessionDoneMark === "boolean" || typeof next.flatListStyle === "boolean" || typeof next.headerViewSwitches === "boolean" || typeof next.conversationNav === "boolean");
...
function ensureHeaderViewSwitches() {
  ...
  if (!section.querySelector('[data-nio-hvswitch="groupBy"]')) {
    const zh2 = isZh();
    const st2 = viewState();
    const tipTextFor = (kind2, mode) => zh2 ? `\u5F53\u524D\u4E3A${modeLabel(kind2, mode)}\uFF0C\u70B9\u51FB\u540E\u5207\u6362\u4E3A${modeLabel(kind2, mode === "flat" ? "workspace" : "flat")}` : `Now ${modeLabel(kind2, mode)}, click to switch to ${modeLabel(kind2, mode === "flat" ? "workspace" : "flat")}`;
    const kind = "groupBy";
    const btn = document.createElement("button");
    btn.type = "button";
    btn.className = "nio-hvswitch";
    btn.setAttribute("data-nio-hvswitch", kind);
    btn.setAttribute("aria-label", zh2 ? "\u5207\u6362\u5206\u7EC4\u65B9\u5F0F" : "Toggle grouping");
    const tip = document.createElement("span");
...
var MARK_KINDS = /* @__PURE__ */ new Set(["user", "steering"]);
var MIN_USER_MESSAGES = 2;
var PANEL_WIDTH = 24;
var BOX_MAX_HEIGHT = 20;
var BOX_MIN_HEIGHT = 5;
var MAX_PANEL_RATIO = 0.55;
var MAX_PANEL_HEIGHT = 520;
var RIGHT_MARGIN = 10;
var SUMMARY_MAX_CHARS = 200;
var SCROLL_PADDING = 12;
var TIP_WIDTH = 280;
...
var Rail = class {
  ...
  handlePointerEnter(target) {
    ...
    if (marker !== null && this.overlay.contains(marker)) {
      ...
      if (row !== void 0) this.showSummary(marker, row);
    } else {
      this.hideSummary();
    }
  }
  ...
  refresh() {
    ...
    const visible = this.rows.length >= MIN_USER_MESSAGES && hasOverflow(scrollport.scrollHeight, scrollport.clientHeight);
    if (!visible) {
  ...
  showSummary(marker, row) {
    ...
    const anchorTop = markerRect.height > 0 ? markerRect.top + markerRect.height / 2 : panelRect.top + panelRect.height / 2;
...
// src/conversation-nav.js
var rails = /* @__PURE__ */ new Map();
function disposeAll() {
  for (const rail of rails.values()) rail.dispose();
  rails.clear();
}
function ensureConversationNav() {
  ...
  for (const element of live) {
    if (!rails.has(element)) {
      try {
        rails.set(element, new Rail(element));
      } catch {
      }
    }
  }
...
function chevronSvg() {
  return import_react.default.createElement(
    ...
    import_react.default.createElement("path", { d: "m6 9 6 6 6-6" })
  );
}
function DescExpandable({ summary, details }) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      { className: "nio-settings-desc-line" },
      import_react.default.createElement("span", { className: "nio-settings-desc-summary" }, summary),
      hasDetails && import_react.default.createElement("button", {
        type: "button",
    ...
    open && hasDetails && import_react.default.createElement(
      "div",
      { className: "nio-settings-desc-detail" },
      details.map((d, i) => import_react.default.createElement("p", { key: i }, d))
    )
  );
}
function ConfigPanel() {
  ...
  return import_react.default.createElement(
    ...
    // ▍侧边栏
    import_react.default.createElement("div", { className: "nio-settings-section" }, "\u4FA7\u8FB9\u680F"),
    // 单列表增强样式
    import_react.default.createElement(
      "div",
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(DescExpandable, {
    ...
    // ▍会话区域
    import_react.default.createElement("div", { className: "nio-settings-section" }, "\u4F1A\u8BDD\u533A\u57DF"),
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          "div",
          { className: "nio-settings-text" },
          import_react.default.createElement("div", { className: "nio-settings-title" }, "\u7528\u6237\u6D88\u606F\u5BFC\u822A\u6761"),
          import_react.default.createElement(DescExpandable, {
    ...
    // ▍系统工具
    import_react.default.createElement("div", { className: "nio-settings-section" }, "\u7CFB\u7EDF\u5DE5\u5177"),
    // 重启按钮
    import_react.default.createElement(
      "div",
      { className: "nio-settings-group" },
