...
var pluginConfig = { enabled: true, editor: "", showRestart: true, menuQuickActions: false };
...
function configDirty() {
  ...
  return pluginConfig.enabled !== configBaseline.enabled || pluginConfig.editor !== configBaseline.editor || pluginConfig.showRestart !== configBaseline.showRestart || pluginConfig.menuQuickActions !== configBaseline.menuQuickActions;
}
...
function ConfigPanel() {
  ...
  return import_react.default.createElement(
    ...
    dirty && import_react.default.createElement(
      "div",
      { className: "nio-settings-banner" },
      import_react.default.createElement("span", { className: "nio-settings-banner-text" }, "\u6709\u914D\u7F6E\u4FEE\u6539\u9700\u8981\u91CD\u542F\u624D\u80FD\u751F\u6548"),
