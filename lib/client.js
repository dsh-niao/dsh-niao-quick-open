...
function ensureHeaderViewSwitches() {
  ...
  setText(groupTip, zh ? `\u5F53\u524D\u4E3A${modeLabel("groupBy", st.groupBy)}\uFF0C\u70B9\u51FB\u540E\u5207\u6362\u4E3A${modeLabel("groupBy", st.groupBy === "flat" ? "workspace" : "flat")}` : `Now ${modeLabel("groupBy", st.groupBy)}, click to switch to ${modeLabel("groupBy", st.groupBy === "flat" ? "workspace" : "flat")}`);
  setText(orderTip, zh ? `\u5F53\u524D\u4E3A${modeLabel("orderBy", st.orderBy)}\uFF0C\u70B9\u51FB\u540E\u5207\u6362\u4E3A${modeLabel("orderBy", st.orderBy === "manual" ? "updated" : "manual")}` : `Now ${modeLabel("orderBy", st.orderBy)}, click to switch to ${modeLabel("orderBy", st.orderBy === "manual" ? "updated" : "manual")}`);
}
registerUIApply(() => {
  try {
